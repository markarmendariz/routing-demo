...
public class RoutingService {
	...
	/*
	  ...
	  Assumptions:
		- Rule #3 only fires if there are more than one common length factors.
	...
	private double calculateScore(String street, String driver) {
		...
		int commonFactors = numberOfCommonFactors(street, driver);
	 ...
	 * street name and driver's name are equal. In the real world the rules should be verified with the system analyst.
	 */
